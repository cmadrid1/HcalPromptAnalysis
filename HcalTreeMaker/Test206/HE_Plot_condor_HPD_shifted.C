...
void HE_Plot_condor_HPD_shifted(string fname="step2prec_HcalSiPMntuple.root", string name="step2prec", int depth=0, bool hpd=true){
	...
	TH1F* htempT2 = NULL;
	if(hpd){
		htempT = makePulseHisto(s105t,70,"reco");
		htempT->SetLineColor(2);
		leg->AddEntry(htempT,"105 [HPD RECO]","l");
		htempT2 = makePulseHisto(s125t,70,"sim");
	...
	TFile *_file0 = TFile::Open("debugcalosamples.root");
	TFile *_file1 = TFile::Open("debugcalosamples_GT.root");
	TFile *_file2 = TFile::Open("debugcalosamples_PS.root");
	TFile *_file3 = TFile::Open("debugcalosamples_PW.root");
	TFile *_file4 = TFile::Open("debugcalosamples_TS.root");
	TFile *_file5 = TFile::Open("debugcalosamples_DC.root");

	TTree *t0b = (TTree*)_file0->Get("CaloSamplesAnalyzer/tree");
	TTree *t1b = (TTree*)_file1->Get("CaloSamplesAnalyzer/tree");
	TTree *t2b = (TTree*)_file2->Get("CaloSamplesAnalyzer/tree");
	TTree *t3b = (TTree*)_file3->Get("CaloSamplesAnalyzer/tree");
	TTree *t4b = (TTree*)_file4->Get("CaloSamplesAnalyzer/tree");
	TTree *t5b = (TTree*)_file5->Get("CaloSamplesAnalyzer/tree");
	...
	t0b->Draw("Iteration$>>htemp0","signalTotPrecise[]*(subdet==2)*(simHitToPhotoelectrons>0)*(simHitToPhotoelectrons<6000)*(((signalTot[4]+signalTot[5])*fCtoGeV*photoelectronsToAnalog)>20)","hist");
	t1b->Draw("Iteration$>>htemp1","signalTotPrecise[]*(subdet==2)*(simHitToPhotoelectrons>0)*(simHitToPhotoelectrons<6000)*(((signalTot[4]+signalTot[5])*fCtoGeV*photoelectronsToAnalog)>20)","hist");
	t2b->Draw("Iteration$>>htemp2","signalTotPrecise[]*(subdet==2)*(simHitToPhotoelectrons>0)*(simHitToPhotoelectrons<6000)*(((signalTot[4]+signalTot[5])*fCtoGeV*photoelectronsToAnalog)>20)","hist");
	t3b->Draw("Iteration$>>htemp3","signalTotPrecise[]*(subdet==2)*(simHitToPhotoelectrons>0)*(simHitToPhotoelectrons<6000)*(((signalTot[4]+signalTot[5])*fCtoGeV*photoelectronsToAnalog)>20)","hist");
	t4b->Draw("Iteration$>>htemp4","signalTotPrecise[]*(subdet==2)*(simHitToPhotoelectrons>0)*(simHitToPhotoelectrons<6000)*(((signalTot[4]+signalTot[5])*fCtoGeV*photoelectronsToAnalog)>20)","hist");
	t5b->Draw("Iteration$>>htemp5","signalTotPrecise[]*(subdet==2)*(simHitToPhotoelectrons>0)*(simHitToPhotoelectrons<6000)*(((signalTot[4]+signalTot[5])*fCtoGeV*photoelectronsToAnalog)>20)","hist");

	//Making DPG plots that are shifted
	
	TH1F *hnew1 = new TH1F("hnew1","hnew1",251,0,251);
	TH1F *hnew2 = new TH1F("hnew2","hnew2",251,0,251);

	int ishift1=24; //to be tuned.
	int ishift2=27; //to be tuned.
	...
	TLegend* catLeg0 = new TLegend(0.7,0.8,0.99,1.0);
        ...
        TLegend* catLeg4 = new TLegend(0.7,0.8,0.99,1.0);
        TLegend* catLeg5 = new TLegend(0.7,0.6,0.99,1.0);
        TLegend* catLeglog0 = new TLegend(0.7,0.8,0.99,1.0);
        TLegend* catLeglog1 = new TLegend(0.7,0.8,0.99,1.0);
        TLegend* catLeglog2 = new TLegend(0.7,0.8,0.99,1.0);
        TLegend* catLeglog3 = new TLegend(0.7,0.8,0.99,1.0);
        TLegend* catLeglog4 = new TLegend(0.7,0.8,0.99,1.0);
        TLegend* catLeglog5 = new TLegend(0.7,0.6,0.99,1.0);
	...
	catLeg0->AddEntry(hnew1,"105 HPD reco","l");
	catLeg0->AddEntry(hnew2,"125 HPD sim","l");
	catLeg0->Draw();
	...
	catLeg1->AddEntry(hnew1,"105 HPD reco","l");
	catLeg1->AddEntry(hnew2,"125 HPD sim","l");
	catLeg1->Draw();
	...
	catLeg2->AddEntry(hnew1,"105 HPD reco","l");
	catLeg2->AddEntry(hnew2,"125 HPD sim","l");
	catLeg2->Draw();
	...
	catLeg3->AddEntry(hnew1,"105 HPD reco","l");
	catLeg3->AddEntry(hnew2,"125 HPD sim","l");
	catLeg3->Draw();
	...
	catLeg4->AddEntry(hnew1,"105 HPD reco","l");
	catLeg4->AddEntry(hnew2,"125 HPD sim","l");
	catLeg4->Draw();
	...
	catLeg5->AddEntry(hnew1,"105 HPD reco","l");
	catLeg5->AddEntry(hnew2,"125 HPD sim","l");
	catLeg5->Draw();
	...
	catLeglog0->AddEntry(hnew1,"105 HPD reco","l");
	catLeglog0->AddEntry(hnew2,"125 HPD sim","l");
	catLeglog0->Draw();
	...
	catLeglog1->AddEntry(hnew1,"105 HPD reco","l");
	catLeglog1->AddEntry(hnew2,"125 HPD sim","l");
	catLeglog1->Draw();
	...
	catLeglog2->AddEntry(hnew1,"105 HPD reco","l");
	catLeglog2->AddEntry(hnew2,"125 HPD sim","l");
	catLeglog2->Draw();
	...
	catLeglog3->AddEntry(hnew1,"105 HPD reco","l");
	catLeglog3->AddEntry(hnew2,"125 HPD sim","l");
	catLeglog3->Draw();
	...
	catLeglog4->AddEntry(hnew1,"105 HPD reco","l");
	catLeglog4->AddEntry(hnew2,"125 HPD sim","l");
	catLeglog4->Draw();
...
/*	//catLeglog5->SetHeader("Pulse Shape");
	...
	catLeglog5->AddEntry(hnew1,"105 HPD reco","l");
	catLeglog5->AddEntry(hnew2,"125 HPD sim","l");
	catLeglog5->Draw();
*/
	//Set Line Color
	...
	htemp5->SetLineColor(8);
        hnew1->SetLineColor(11);
	hnew2->SetLineColor(9);
	...
	Double_t norm =1;
        ...
        Double_t hmin1 = hnew1->GetMaximumBin();
        Double_t hmax1 = hnew1->GetMaximumBin();
        Double_t hmin2 = hnew2->GetMaximumBin();
        Double_t hmax2 = hnew2->GetMaximumBin();
        ...
        hnew1->Scale(norm/hnew1->Integral(hmin1,hmax1));
        hnew2->Scale(norm/hnew2->Integral(hmin2,hmax2));
	...
	c0->SaveAs("HE_2017_Shifted_10000Events_PulseShape_HPD_vsHPD_Standard_no_GT_PS_PW_TS_DC.pdf");

	c2->SaveAs("HE_2017_Shifted_10000Events_logPulseShape_HPD_vsHPD_Standard_no_GT_PS_PW_TS_DC.pdf");
