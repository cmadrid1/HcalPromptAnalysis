...
void plot_compare_MC_MC(const char *Data_File, const char *MC_File, const char *run_number = "<Run Number>", const char *MC_Type = "<MC Type>" , const char *Name_Save = "Data_vs_MC.pdf"){
