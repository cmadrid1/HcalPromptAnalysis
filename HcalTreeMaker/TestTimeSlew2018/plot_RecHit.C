...
void plot_RecHit(const char *HB_Title = "HB_Title",const char *HE_Title = "HE_Title",const char *HB_Name_Save = "HB_NewTimeSlew_Reco.pdf",const char *HE_Name_Save = "HB_NewTimeSlew_Reco.pdf"){
  ...
  double ytime_min = -15.0;
  double ytime_max =  15.0;
  ...
  h5 = defineTH1F("Output_Histo_RecHit.root","chi2_energyHE");
  h6 = defineTH2F("Output_Histo_RecHit.root","TH2_chi2_energyHE");
  h7 = defineTH2F("Output_Histo_RecHit.root","M2vsM0_HE");
  h8 = defineTH2F("Output_Histo_RecHit.root","TH2_time_energyHE");
